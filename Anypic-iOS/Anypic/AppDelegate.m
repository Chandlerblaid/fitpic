...
#import "PAPProfileViewController.h"
...
@property (nonatomic, strong) PAPProfileViewController *profileViewController;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Parse setApplicationId:@"lLbnrkpZyaE1kL7ce7ajGT7qOVy0HHezTfu7BGYq" clientKey:@"ho8oBiGY9aL28V9TP6byFnDfqgKahPMoTfH034c6"];
    //
    ...
    [PFFacebookUtils initializeWithApplicationId:@"727421743990766"];
    // ****************************************************************************
...
- (void)presentTabBarController {
    ...
    self.profileViewController = [[PAPProfileViewController alloc] initWithStyle:UITableViewStylePlain];
    ...
    self.exploreViewController = [[PAPExploreViewController alloc] initWithStyle:UITableViewStylePlain];
    ...
    [PAPUtility addBottomDropShadowToNavigationBarForNavigationController:profileNavigationController];
    [PAPUtility addBottomDropShadowToNavigationBarForNavigationController:emptyNavigationController];
    [PAPUtility addBottomDropShadowToNavigationBarForNavigationController:exploreNavigationController];
    ...
    UITabBarItem *profileTabBarItem = [[UITabBarItem alloc] initWithTitle:@"Profile" image:nil tag:0];
    [profileTabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"IconHomeSelected.png"] withFinishedUnselectedImage:[UIImage imageNamed:@"IconHome.png"]];
    [profileTabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                            [UIColor colorWithRed:86.0f/255.0f green:55.0f/255.0f blue:42.0f/255.0f alpha:1.0f], UITextAttributeTextColor,
                                            nil] forState:UIControlStateNormal];
    [profileTabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                            [UIColor colorWithRed:129.0f/255.0f green:99.0f/255.0f blue:69.0f/255.0f alpha:1.0f], UITextAttributeTextColor,
    ...
    UITabBarItem *exploreTabBarItem = [[UITabBarItem alloc] initWithTitle:@"Explore" image:nil tag:0];
    [exploreTabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"IconTimelineSelected.png"] withFinishedUnselectedImage:[UIImage imageNamed:@"IconTimeline.png"]];
    [exploreTabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                               [UIColor colorWithRed:86.0f/255.0f green:55.0f/255.0f blue:42.0f/255.0f alpha:1.0f], UITextAttributeTextColor,
                                               nil] forState:UIControlStateNormal];
    [exploreTabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                               [UIColor colorWithRed:129.0f/255.0f green:99.0f/255.0f blue:69.0f/255.0f alpha:1.0f], UITextAttributeTextColor,
    ...
    [self.tabBarController setViewControllers:[NSArray arrayWithObjects:homeNavigationController, profileNavigationController, emptyNavigationController, exploreNavigationController, activityFeedNavigationController, nil]];
